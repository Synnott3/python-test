...
shopping_list = ["milk","egg","flour","banana","orange"] # Fill in with some values
...
nutrition_facts = {"calories": 170, "fat": 8, "protein": 2} # Fill in with the nutrition facts from the label

print(nutrition_facts) # Print all the nutrition facts

print(nutrition_facts["fat"]) # Uncomment this line and pick a value to print individually
